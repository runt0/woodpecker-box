...
public class RaqsoftReportCenter_DataSphereServlet_ArbitraryFileUpload_Plugin implements IVulPlugin {
    ...
    public void VulPluginMain(IVulPluginCallbacks iVulPluginCallbacks) {
        ...
        vulPluginCallbacks.setVulPluginName("润乾报表DataSphereServlet接口任意文件上传插件");
        vulPluginCallbacks.setVulName("润乾报表DataSphereServlet接口任意文件上传漏洞");
        ...
        vulPluginCallbacks.registerPoc(new DataSphereServlet_ArbitraryFileUpload_POC());
    }
}
